    ...
    <footer className="bg-dark-900 border-t border-dark-600">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Brand */}
          <div>
            <p className="font-display text-4xl tracking-widest uppercase text-white mb-3">
              AL<span className="text-smoke">SHOP</span>
            </p>
            <p className="text-sm text-dark-400 leading-relaxed max-w-xs">
              Gorras urbanas de edición limitada. Streetwear premium con diseños exclusivos.
            </p>
          </div>
          ...
          {/* Contact */}
          <div>
            <p className="text-[10px] uppercase tracking-[0.2em] text-neon-cyan mb-4">Contacto</p>
