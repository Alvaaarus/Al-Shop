...
import { getProductosNuevos } from '@/data/productos';
import ProductCard from '@/components/ProductCard';

export default function HomePage() {
  const nuevos = getProductosNuevos();
  ...
  return (
    <>
      ...
      {/* Limited Drops */}
      {nuevos.length > 0 && (
        <section id="drops" className="bg-dark-900 py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-end justify-between mb-12">
              <div>
                <p className="text-[10px] uppercase tracking-[0.3em] text-neon-yellow mb-2">Nuevas Entregas</p>
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory -mx-4 px-4 md:grid md:grid-cols-4 md:overflow-visible md:mx-0 md:px-0">
              {nuevos.map((producto) => (
                <div key={producto.id} className="flex-shrink-0 w-[65vw] sm:w-[45vw] md:w-auto snap-start">
      ...
      {/* WhatsApp CTA */}
      <section className="relative bg-dark-800 py-16 overflow-hidden">
        {/* Background glow */}
